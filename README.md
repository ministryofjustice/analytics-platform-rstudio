...
**NB Changes in this repository are public**
This work is done in an [internal repository](https://github.com/ministryofjustice/analytics-platform-rstudio) and immediately sync'ed to a [public copy](https://github.com/ministryofjustice/analytics-platform-rstudio-public).
